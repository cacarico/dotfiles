...
vim.cmd("highlight GitSignsAdd guifg=#db2a90")
...
require("gitsigns").setup({
	...
	on_attach = function(bufnr)
		...
		vim.keymap.set("n", "<leader>gb", "<cmd>Git blame<CR>", { desc = "Opens [g]it [b]lame" })
		vim.keymap.set("n", "<leader>gB", "<cmd>GBrowse<CR>", { desc = "Opens buffer on browser" })
		vim.keymap.set("n", "<leader>gl", "<cmd>Gclog<CR>", { desc = "Opens [g]it [l]og" })
	end,
})
